...
{
    set_bit_val(MPU6050_INFO::REGISTER::PWR_MGMT_1, BIT::MASK8::BITM1_6, (uint8_t)SIX, 0);
}

template <typename T_I2C_bus>
void MPU6050<T_I2C_bus>::config()
{
    set_bit_val(MPU6050_INFO::REGISTER::CONFIG, BIT::MASK8::BITM3_0, (uint8_t)ZERO, MPU6050_INFO::BIT_FLAGS::CONFIG::DLPF_CFG_1);
    ...
    set_bit_val(MPU6050_INFO::REGISTER::ACCEL_CONFIG, BIT::MASK8::BITM2_3, (uint8_t)THREE, MPU6050_INFO::BIT_FLAGS::ACCEL_CONFIG::AFS_SEL_2);
}
